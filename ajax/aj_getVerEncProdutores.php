<?php
	...
	$q = $conDB->sql_query("SELECT products.id, products.product_name, products.price, SUM(encomenda_has_products.quant ), SUM(products.price*encomenda_has_products.quant), encomenda.semana FROM encomenda, encomenda_has_products, people, products WHERE encomenda_has_products.id_produtor=people.id_people
...
AND people.id_people='$targetID' GROUP BY products.id");
