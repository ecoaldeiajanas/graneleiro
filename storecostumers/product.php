...
<?php require_once("../includes/core/header.php"); ?> 
    ...
    <?php if($erro==''){?>
    	...
    	<form id="form1" name="form1" method="post" <?php if($add==0){?>action="cart.php"<?php }else{?> action="ver_encomenda.php"<?php }?>
      		<p><?php if($unit=='1'|| $peso==1){
                     ...
                     <br/>
                     <p><b>Preço</b></p>
      <p ><h2 style="color:orange"><?php if($unit=='1'){echo $price." €/Unid.";}else{echo $price." €/kg";}?></h2></p><br/>
  ...
  <?php if($unit=='1' || $peso=='1' ){?>
      ...
      <input type="hidden" name="total" id="total" value="<?php  echo $total;?>" />
        ...
        <input type="hidden" name="cat" id="cat" value="<?php echo $id_category;?>" />
    ...
    <td width="52%" align="left" valign="top" scope="col"><p><?php echo "<b>Produtor</b><br/>".$produtor." - ".$concelho; ?><br/></p>
    	<?php if($peso=='1'){ echo "<hr><p><b>Info</b><br/>Produto vendido à unidade mas facturado ao peso.<br/>Necessário aferir o peso no <u>local de entrega</u>.</p>"; }?>
        <?php 
...
<?php }else{ echo '<br/>Caso pretenda alterar a quantidade do produto em questão, deverá faze-lo em <b><u><a href="ver_encomenda.php">VER ENCOMENDA</a></u></b> ';}?>
